...
[Site de replt.it](./images/00.png)

Desde ahí puedes pulsar el botón `Start coding`:

[Start Coding en replt.it](./images/01.png)

Y seleccionar el lenguaje **Python**:

[Selección de Python en replt.it](./images/02.png)

Una vez hecho, se cargará el entorno de programación:

[Entorno de desarrollo de replt.it](./images/03.png)
