...
Usando el índice numérico, se pueden sacar partes de una lista, creando una sub-lista de la misma. Para eso basta con indicar un rango de índices:
...
```
### Ejercicio 3.9
Crea un programa que defina una array iniciado con 10 números enteros. Luego crea otro bucle que contabilice el total de números positivos, negativos y los que sean 0.
...
### Ejercicio 3.10
Crea un programa que defina un array de dos dimensiones de 5x10 elementos. Crea un bucle que inicie los valores del array usando números aleatorios.
...
### Ejercicio 3.11
Crea un proyecto que defina un array iniciado con 10 números enteros. En un bucle muestra por pantalla todos los elementos. Luego crea otro bucle que baraje los elementos usando el método random del ejercicio anterior en los índices. Luego muestra el resultado.
